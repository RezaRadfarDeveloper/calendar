...
export default {
  ...
  mounted() {
    ...
    this.selectedMonth = this.getLastMonthOnPage
      ? this.getLastMonthOnPage
  ...
  methods: {
    ...
    getNextMonth() {
      if (this.getMonthCounter === 1) this.setSelectedMonth("NextMonth");
      else this.setSelectedMonth("Current");
      ...
      } else this.selectedMonth = this.months[currentMonthNum + 1];
    ...
    getPreviousMonth() {
      ...
      if (this.getMonthCounter === 2) this.setSelectedMonth("Current");
      else this.setSelectedMonth("NextMonth");
  ...
  computed: {
    ...
    daysInThisMonth() {
      ...
      return new Date(
        now.getFullYear(),
        now.getMonth() + this.getMonthCounter,
        0
      ).getDate();
    },
    daysInNextMonth() {
      ...
      return new Date(
        now.getFullYear(),
        now.getMonth() + this.getMonthCounter + 1,
        0
      ).getDate();
    },
  },

    ...
    <div class="personal-detail-form">
      ...
      <div class="row-name">
        <div class="name-row-first">
          ...
          <input
            ...
            type="text"
            :class="{ 'is-invalid': formErrors.name && getValidationClicked }"
            v-model="patientName"
          />
          <div
            v-if="formErrors.name !== '' && getValidationClicked"
            :class="{
              'is-invalid-text': formErrors.name && getValidationClicked,
            }"
          >
            {{ errors.name }}
          </div>
        ...
        <div class="name-row-first">
          ...
          <input
            @keyup="updateValidation"
            type="text"
            :class="{ 'is-invalid': formErrors.family && getValidationClicked }"
            v-model="patientFamily"
          />
          <div
            v-if="formErrors.family !== '' && getValidationClicked"
            :class="{
              'is-invalid-text': formErrors.family && getValidationClicked,
            }"
          >
            {{ formErrors.family }}
          </div>
      ...
      <div class="row-birth">
        <div class="birth-date">
          <label for="" class="birth-label">Date of Birth (Optional)</label>
      ...
      <div class="d-flex justify-content-between">
        <div class="name-row-first">
          ...
          <input
            @keyup="updateValidation"
            type="text"
            :class="{ 'is-invalid': formErrors.email && getValidationClicked }"
            v-model="email"
          />
          <div
            v-if="formErrors.email !== '' && getValidationClicked"
            :class="{
              'is-invalid-text': formErrors.email && getValidationClicked,
            }"
          >
            {{ formErrors.email }}
          </div>
        ...
        <div class="name-row-first">
          ...
          <input
            ...
            v-model="password"
            :class="{
              'is-invalid': formErrors.password && getValidationClicked,
            }"
          />
          <div
            v-if="formErrors.password !== '' && getValidationClicked"
            :class="{
              'is-invalid-text': formErrors.password && getValidationClicked,
            }"
          >
            {{ formErrors.password }}
          </div>
      ...
      this.setFormErrors({
        ...
        password:
          this.password.length < 8
            ? "password is required and should be at least 8 character"
            : "",
      });
    },
